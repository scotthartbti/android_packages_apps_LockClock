...
public class WeatherInfo {
    ...
    public WeatherInfo(Context context,
        ...
        this.mSharedPrefs = mContext.getSharedPreferences(PREF_NAME, Context.MODE_PRIVATE);
    }

    public int getConditionResource() {
        int mWeatherStyleIcons = Integer.parseInt(mSharedPrefs.getString(
                Constants.WEATHER_ICON_STYLE, "0"));
        int weatherIconNa;
